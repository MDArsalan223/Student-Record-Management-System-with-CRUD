...
class Home(View):
    def get(self, request):
        ...
        print(stu_data)  # Debug statement
        return render(request, 'core/home.html', {'studata':stu_data})
    

# making view for addstudent
